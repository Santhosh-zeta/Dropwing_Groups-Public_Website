...
const SignalHero = () => {
    ...
    return (
        <section className="relative h-screen w-full overflow-hidden bg-[#0a0a0c] text-white flex items-center justify-center">
            {/* Background Noise Layer — subtle buzzing corporate jargon in the dark */}
            <div className="absolute inset-0 opacity-[0.07] select-none pointer-events-none overflow-hidden flex flex-wrap content-start gap-4 p-4">
                {noiseArray.map((word, i) => (
                    <span
                        key={i}
                        className="text-xs md:text-sm font-bold uppercase tracking-widest text-white"
                        style={{
            ...
            <div className="relative z-10 text-center">
                <div className="w-[1px] h-32 bg-white/30 mx-auto mb-8 animate-pulse" />
                ...
                <motion.p
                    ...
                    className="text-xl md:text-2xl font-mono tracking-wide uppercase text-white/60"
                >
...
const Philosophy = () => {
    return (
        <div className="min-h-screen bg-black text-gray-200 font-sans selection:bg-white selection:text-black">
            ...
            {/* 4. THE COVENANT */}
            <section className="py-40 bg-[#0d0d10] text-white relative border-b border-white/10">
                <div className="container mx-auto px-6 max-w-3xl text-center">
                    <div className="mb-12 flex justify-center text-white/20">
                        <FileCheck className="w-16 h-16" />
                    </div>

                    <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-12 text-white">
                        The Operating Covenant.
                    </h2>

                    <div className="text-xl md:text-2xl leading-relaxed font-serif text-white/70 space-y-8">
                        <p>
                    ...
                    <div className="mt-20 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8 font-mono text-sm uppercase tracking-widest text-white/30">
                        <div>
                            Signed: Dropwing Groups
                        </div>
                        <div className="h-px w-32 bg-white/10 md:hidden" />
                        <div>
